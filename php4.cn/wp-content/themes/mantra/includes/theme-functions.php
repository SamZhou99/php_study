...
foreach ($mantra_options as $key => $value) {	
	...
	<div id="site-info" >
		<a href="<?php echo home_url( '/' ) ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home">
			...
			'Cryout Creations';?>"><?php echo 'Mantra' ?></a> &amp; <a href="<?php echo esc_url('http://wordpress.org/' ); ?>"  title="<?php esc_attr_e('Semantic Personal Publishing Platform', 'mantra'); ?>"> <?php printf(' %s.', 'WordPress' ); ?></a>|<?php _e('汉化','mantra')?> <a href="<?php echo 'http://yiranboke.com';?>" title="科技博客"><?php echo '怡然博客' ?></a> 
		</a>
	</div><!-- #site-info -->
<?php }
