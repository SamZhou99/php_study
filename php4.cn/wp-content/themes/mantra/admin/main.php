...
$page = add_theme_page('Mantra Settings', 'Mantra 设置', 'edit_theme_options', 'mantra-page', 'mantra_page_fn');
...
<div id="righty" ><!-- Right side of page - Coffee, RSS tips and others -->
	<div class="postbox donate"> 
		...
		<div class="inside"><?php _e("<p>在 Cryout Creations (Mantra 主题的开发商), 日以继夜地完善Mantra主题。我们修复了大量bug(这是我们以前所造成的); 我们在尽可能保持主题简单的同时，不断添加更多的自定义选项。然后。。。我们现在就像在玩一场博弈，但请放心，我们回去会读和回复你们昨晚的email和评论，做好记录，并且在未来的版本进行实施。</p><p>因此，你可能会问你自己： <i>他们是如何做到这一点的? 他们在为主题辛苦工作后是如何保持精力充沛的？</i> 伙计，这很简单。我们喝咖啡了。大量的热煮咖啡。我们非常喜欢。因此，如果你想帮助Mantra主题的后续开发...</p> ","mantra"); ?>
...
uGoJV/7kErByS98U5Gze/kUo5OvpezDjckdR0TJfoNFDKiAit+Qf9+ToViM/CmY2cONArejftWlnEKikB7UxCFuA3uPj8lXq5KXvukDTdrDJicqh+vZvjDr2ipMsrEl+BgRsUsYamXRosq6U/bT/zcmXcdgdbg44pJQ==-----END PKCS7-----"><input type="image" src="<?php echo get_template_directory_uri() . '/admin/images/coffee.png' ?>" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!"><img alt="" border="0" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif" width="1" height="1"></form>		
	...
	<div class="postbox support"> 
		...
		<?php _e("
			<ul>
				<li>- 需要关于Mantra或者Wordpress方面的帮助?</li>
				<li>- 想知道主题的每一个版本有什么更改?</li>
				<li>- 发现bug或者有些东西不想预期中那样准确?</li>
				<li>- 有一个如何改进Mantra主题一更好适应你的需求的想法?</li>
				<li>- 要想设置实施?</li>
				<li>- 你已经或者你想对Mantra主题进行翻译?</li>
			</ul>
			<p>那么，访问我们Mantra主题的支持页面。</p>
	","mantra"); ?>
